...
export default function ReportPreview() {
  ...
  const [activeView, setActiveView] = useState<"preview" | "edit" | "data-mapping">("preview");
  ...
  const handleSaveEdit = async () => {
    if (!generatedReport || !editingSectionId) return;
    
    setIsSaving(true);
    try {
      await updateReportSection(generatedReport.id, editingSectionId, editingContent);
  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted-foreground mb-6">
        Review your generated report and make any necessary edits.
      </p>
