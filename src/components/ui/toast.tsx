...
// Simplified toast component without Radix UI dependency
// This is a temporary solution until the Radix UI dependency is installed
...
>(({ className, ...props }, ref) => (
  <button
    ...
    onClick={(e) => {
      e.stopPropagation();
      const toast = e.currentTarget.closest('[role="alert"]');
      if (toast) {
        const openChangeHandler = (toast as any).__openChangeHandler;
        if (typeof openChangeHandler === 'function') {
