...
const DynamicMedicalHistory = dynamic(
  () => import('./SimpleMedicalHistory'),
  {
    loading: () => <div className="p-4 text-center">Loading Medical History section...</div>,
    ssr: false
  }
);
...
const FallbackComponent = () => (
  <div className="p-6 border-2 border-orange-200 bg-orange-50 rounded-md">
    ...
    <p className="text-orange-700">
      The Medical History section encountered an error and cannot be displayed.
    </p>
