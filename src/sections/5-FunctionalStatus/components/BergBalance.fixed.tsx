...
export function BergBalance() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        {bergItems.map((item) => {
          const itemPath = `data.bergBalance.${item.id}`;
            ...
            <Card key={item.id} className="border">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <select 
                    value={watch(`${itemPath}.score`)?.toString() || ''}
                    onChange={(e) => setValue(`${itemPath}.score`, Number(e.target.value))}
      ...
      <div className="border p-4 rounded-md">
        <div className="flex items-center space-x-2">
          <input
            ...
            checked={watch("data.bergBalance.completedItems") || false}
            onChange={(e) => setValue("data.bergBalance.completedItems", e.target.checked)}
      ...
      <div>
        ...
        <textarea
          ...
          value={watch("data.bergBalance.generalNotes") || ''}
          onChange={(e) => setValue("data.bergBalance.generalNotes", e.target.value)}
