...
export function EnhancedROM() {
  ...
  // Simplified ROM percentage options with approximate/estimated ranges
  const rangeOptions = [
  ...
  // Streamlined joint regions in logical anatomical order
  const jointRegions = [
    {
      region: 'cervical',
