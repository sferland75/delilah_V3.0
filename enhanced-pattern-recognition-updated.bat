@echo off
echo Delilah V3.0 - Enhanced Pattern Recognition Training (Updated)
echo ======================================================
echo.
echo This script will:
echo 1. Process all PDF files from the d:\delilah-agentic\IHAs directory
echo 2. Build a comprehensive pattern recognition model from 50+ documents
...
echo - Using updated path: d:\delilah-agentic\IHAs
echo.
...
node process-all-ihas-updated.js
